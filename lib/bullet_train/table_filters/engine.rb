...
module BulletTrain
  module TableFilters
    class Engine < ::Rails::Engine
      ...
      # Test if view can be found
      # lookup = ActionView::LookupContext.new(Rails.application.config.paths["app/views"].expanded)
      # lookup.find_all("bullet_train/table_filters/shared/search_form", [], true)
    end
  end
end
